 ...
 *
 *              fgic_fx() must not directly update fgic->ecm data object because fgic_fx() is called for
 *              each sigma point 
 *
 *---------------------------------------------------------------------------------------------------------------------
 */
 ...
 *        		z[1] = T 
 *
 *  @note	fgic_hx() must not directly update fgic->ecm because it is called at multiple sigma points.
 *
 *---------------------------------------------------------------------------------------------------------------------
 */
static
