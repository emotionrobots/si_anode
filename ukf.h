 ...
 * @file	ukf.h
 *
 * @brief	Unscented Kalman filter header
 *
 *=====================================================================================================================
 */
#ifndef __UKF_H__
...
#define UKF_MAX_SIGMA 		(2 * UKF_MAX_N + 1)		/* number of UKF sigma points */
 ...
 *---------------------------------------------------------------------------------------------------------------------
 */
ukf_status_t ukf_init(ukf_t *ukf, int n_x, int n_z, ukf_float alpha, ukf_float beta, ukf_float kappa);
 ...
 *---------------------------------------------------------------------------------------------------------------------
 */
ukf_status_t ukf_set_state(ukf_t *ukf, const ukf_float *x0, const ukf_float *P0);
 ...
 *---------------------------------------------------------------------------------------------------------------------
 *
 *  @fn		ukf_status_t ukf_update(ukf_t *ukf, const ukf_float *z);
 *
