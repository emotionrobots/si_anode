 ...
 */
static 
void mat_transpose(ukf_float *AT,
                   const ukf_float *A,
                   int rows, int cols)
{
 ...
 *
 *  @brief	Peforem constant times vector 
 *
 *---------------------------------------------------------------------------------------------------------------------
 */
static 
 ...
 *
 *  @return	0 on success, non-zero on failure (singular).
 *
 *---------------------------------------------------------------------------------------------------------------------
 */
static 
 ...
 *  @brief	Intialize UKF
 *
 *  @param	ukf:		UKF pointer
 *  @param	n_x:		number of state vars
 *  @param	n_z:		number of measurement vars
 *  @param	alpha:
 *  @param	beta:
 *  @param	kappa:
 *
 ...
 *
 *  @brief	Set process noise (Q) and measurement noise (R)
 *
 *----------------------------------------------------------------------------------------------------------------------
 */
 ...
 *
 *  @brief	Set UKF process and measurement models
 *
 *----------------------------------------------------------------------------------------------------------------------
 */
 ...
 * 
 *  @note	Also scales P by (n_x + lambda) before chol.
 *
 *----------------------------------------------------------------------------------------------------------------------
 */
static 
 ...
 * 			3. Compute predicted mean x from sigma points 'sigma_x'
 * 			4. Compute predicted covariance P (uncertainty)
 *			5. Update P with process noise Q that will increase uncertainty
 *
 *----------------------------------------------------------------------------------------------------------------------
 */
 ...
 * 			3. Compute measurement covariance S, then update S with measurement noise R 
 * 			4. Compute cross covariance P_xz 
 * 			5. Compute Kalman gain K = P_xz * S^-1 
 * 			6. Update state x and covariance P
 *
 *  @param	ukf:		UKF pointer
 *  @param	z_meas:		measurements
 *
 *----------------------------------------------------------------------------------------------------------------------
 */
